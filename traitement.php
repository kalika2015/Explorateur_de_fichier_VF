     ...
     foreach($dirs as $dir){
        if (is_dir($url.$dir)){
             if ($dir == "..") {
                ...
                if (isset($_GET['dossier'])) {?>
                    <a class="folder" href="explorateur.php?dossier=<?php echo $dossier.$dir; ?>/">
                        <img src="icone/Burn_2.png" alt="" width="60">
                        <span><?php echo $dir;?></span>
                    </a>
                <?php } else {?>
                    <a class="folder" href="explorateur.php?dossier=<?php echo $dir ?>/">
                        <img src="icone/Burn_2.png" alt="" width="60"><?php echo $dir; ?>
                    </a>
                <?php }
            }
        } else {
            if (isset($dir)){
                ...
                if ($extension == "html"){
                    ...
                    <a class="folder" href="../<?php echo $dossier.$dir; ?>">
                        <img src="icone/html.png" alt="" width="60"><?php echo $dir; ?>
                    </a>
                    <?php
                } elseif ($extension == "css"){
                    ?>
                    <a class="folder" href="../<?php echo $dossier.$dir; ?>">
                        <img src="icone/css.png" alt="" width="60"><?php echo $dir; ?>
                    </a>
                    <?php
                } elseif ($extension == "png"){
                    ?>
                    <a class="folder" href="../<?php echo $dossier.$dir; ?>">
                        <img src="icone/png.png" alt="" width="60"><?php echo $dir; ?>
                    </a>
                    <?php
                } elseif ($extension == "js"){
                    ?>
                    <a class="folder" href="../<?php echo $dossier.$dir; ?>">
                        <img src="icone/javascript.png" alt="" width="60"><?php echo $dir; ?>
                    </a>
                    <?php
                } elseif ($extension == "php"){
                    ?>
                    <a class="folder" href="../<?php echo $dossier.$dir; ?>">
                        <img src="icone/php.png" alt="" width="60"><?php echo $dir; ?>
                    </a>
                    <?php
                } elseif ($extension == "pdf"){
                    ?>
                    <a class="folder" href="../<?php echo $dossier.$dir; ?>">
                        <img src="icone/pdf.png" alt="" width="60"><?php echo $dir; ?>
                    </a>
                    <?php
                    ...
                    ?>
                    <a class="folder" href="../<?php echo $dossier.$dir; ?>">
                        <img src="icone/txt.png" alt="" width="60"><?php echo $dir; ?>
                    </a>
                    <?php
                }
            }
